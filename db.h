...
/* This token_list definition is used for breaking the command
   string into separate tokens in function get_token().  For
...
char *keyword_table[] = 
{
  ...
  "update", "set", "select", "order", "by", "desc", "is", "and", "or","group","natural","join",
  "sum", "avg", "count"
};
...
typedef enum error_return_codes
{
  ...
  INVALID_REPORT_FILE_NAME,       // -388
    INVALID_SYNTAX,             //-387
    DATA_MISMATCH,               //-386
    INVALID_COLUMN_ENTRY,         //-385
    NULL_VALUE_INSERTED,        //-384
    INVALID_RELATIONAL_OPERATOR,     //-383
    INVALID_AGGREGATE_FUNCTION_PARAMETER, //-382
